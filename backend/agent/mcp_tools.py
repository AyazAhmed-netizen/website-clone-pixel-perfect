...
TOOL_DEFINITIONS = [
    {
        "name": "crawl_website",
        "description": """\U0001f310 CRITICAL TOOL - Crawl and extract a website URL for cloning.

**USE THIS FIRST when the user provides a URL to clone!**
This tool crawls the website using Playwright, extracts DOM, styles, images, and components,
and saves everything to the source cache. Returns a source_id you can use with get_layout().

**When to use:**
- User provides a URL (e.g., "clone https://example.com")
- User asks to replicate/copy/clone a website
- Any time you need to extract a website before cloning

**Workflow:**
1. crawl_website(url="https://example.com") → returns source_id
2. get_layout(source_id="...") → get page sections
3. spawn_section_workers(sections=[...]) → generate components
4. Write App.jsx, index.css

**Returns:**
- source_id: Use this with get_layout() and spawn_section_workers()
- page_title: Title of the extracted page
- element_count: Number of DOM elements extracted
- available_data: What data is available (dom_tree, styles, etc.)

**IMPORTANT:** This tool takes 10-30 seconds to complete as it opens a browser and extracts the page.""",
        "input_schema": {
            "type": "object",
            "properties": {
                "url": {
                    "type": "string",
                    "description": "The website URL to crawl and extract (must start with http:// or https://)"
                },
                "viewport_width": {
                    "type": "integer",
                    "description": "Viewport width for extraction (default: 1920)",
                    "default": 1920
                },
                "viewport_height": {
                    "type": "integer",
                    "description": "Viewport height for extraction (default: 1080)",
                    "default": 1080
                }
            },
            "required": ["url"]
