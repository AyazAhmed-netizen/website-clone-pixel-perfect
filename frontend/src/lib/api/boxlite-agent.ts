 ...
 *
 * Key features:
 * - Connects to sandbox backend (port 5001)
...
const BOXLITE_BACKEND_URL = process.env.NEXT_PUBLIC_API_URL || "http://localhost:5001";
...
export type ClientMessageType = "chat" | "state_refresh" | "ping" | "stop_agent";
